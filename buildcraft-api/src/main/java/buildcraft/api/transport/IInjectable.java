...
public interface IInjectable {
     ...
     * This should never be called on the client side! Implementors are free to throw an exception if called on the
     * client side.
     *
    ...
    @Nonnull
    ItemStack injectItem(@Nonnull ItemStack stack, boolean doAdd, Direction from, @Nullable DyeColor color, double speed);
}
