...
public class ColourUtil {
    ...
    static {
        ...
        // Modern MC DyeColor ordinals: WHITE=0, ORANGE=1, MAGENTA=2, LIGHT_BLUE=3,
        // YELLOW=4, LIME=5, PINK=6, GRAY=7, LIGHT_GRAY=8, CYAN=9, PURPLE=10,
     ...
     * that the special colour tooltips can add. */
